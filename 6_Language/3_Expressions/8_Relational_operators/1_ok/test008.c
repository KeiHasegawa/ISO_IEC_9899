...
int test_014 = &array[1] <= &array[0];
int test_015 = &array[1] >= &array[0];

int test_016 = &array[1] < &array[1];
int test_017 = &array[1] > &array[1];
int test_018 = &array[1] <= &array[1];
int test_019 = &array[1] >= &array[1];

int test_020 = &array[1] < &array[2];
int test_021 = &array[1] > &array[2];
int test_022 = &array[1] <= &array[2];
int test_023 = &array[1] >= &array[2];

int test_024 = (int*)1 < (int*)0;
int test_025 = (int*)1 > (int*)0;
int test_026 = (int*)1 <= (int*)0;
int test_027 = (int*)1 >= (int*)0;

int test_028 = (int*)1 < (int*)1;
int test_029 = (int*)1 > (int*)1;
int test_030 = (int*)1 <= (int*)1;
int test_031 = (int*)1 >= (int*)1;

int test_032 = (int*)1 < (int*)2;
int test_033 = (int*)1 > (int*)2;
int test_034 = (int*)1 <= (int*)2;
int test_035 = (int*)1 >= (int*)2;
